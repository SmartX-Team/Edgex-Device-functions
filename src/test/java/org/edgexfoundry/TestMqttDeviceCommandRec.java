...
public class TestMqttDeviceCommandRec implements MqttCallback {
  ...
  private static String REQ_MQTT_BROKER = "m12.cloudmqtt.com";
  private static String REQ_MQTT_PROTOCOL = "tcp";
  private static int REQ_MQTT_BROKER_PORT = 13070;
  private static String REQ_MQTT_CLIENT_ID = "OutgoingCommandSubscriber";
  private static String REQ_MQTT_TOPIC = "CommandTopic";
  private static String REQ_MQTT_USER = "zkpjpyvu";
  private static String REQ_MQTT_PASS = "t0wk44d5Lux9";

  private static String RESP_MQTT_BROKER = "m12.cloudmqtt.com";
  private static String RESP_MQTT_PROTOCOL = "tcp";
  private static int RESP_MQTT_BROKER_PORT = 13070;
  private static String RESP_MQTT_CLIENT_ID = "CommandResponsePublisher";
  private static String RESP_MQTT_TOPIC = "ResponseTopic";
  private static String RESP_MQTT_USER = "zkpjpyvu";
  private static String RESP_MQTT_PASS = "t0wk44d5Lux9";
