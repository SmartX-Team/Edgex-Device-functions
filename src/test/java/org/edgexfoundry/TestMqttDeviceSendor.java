...
public class TestMqttDeviceSendor {
  ...
  private static String MQTT_BROKER = "m12.cloudmqtt.com";
  private static String MQTT_PROTOCOL = "tcp";
  private static int MQTT_BROKER_PORT = 13070;
  private static String MQTT_CLIENT_ID = "IncomingDataPublisher";
  private static String MQTT_TOPIC = "DataTopic";
  private static String MQTT_USER = "zkpjpyvu";
  private static String MQTT_PASS = "t0wk44d5Lux9";
